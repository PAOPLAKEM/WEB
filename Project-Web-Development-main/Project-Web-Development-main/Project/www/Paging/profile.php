    ...
    <body>
		...
		<div class="content" id="content">
			...
			<?php while ($row = $stmt->fetch()) :?>
				...
				<tr><td>ชื่อ:           <?=$row["name_cus"]?><br></td></tr>
				<tr><td>นามสกุล:       <?=$row["sur_cus"]?><br></td></tr>
				<input type="hidden" id="Ph" value="<?=$row["Phone_cus"]?>">
				<tr><td>เบอร์:          <?=$row["Phone_cus"]?><br></td></tr>
				<tr><td>ที่อยู่:          <?=$row["address"]?><br></td></tr>
				<tr><td>Username:      <?=$row["Username"]?><br></td></tr>
				<?php endwhile?> 
			</table>
				<input type="button" onclick="send()" value="แก้ไข">
				<br>
				<br>
				<br>
				<br>
